...
const states=[
  ["Rajasthan","Desert crafts",23,18,"craft"],
  ["Punjab","Harappa",38,23,"history"],
  ["Bihar","Madhubani",53,34,"art"],
  ["West Bengal","Baul",69,37,"music"],
  ["Gujarat","Garba",35,43,"performance"],
  ["Maharashtra","Warli",45,55,"art"],
  ["Andhra Pradesh","Kalamkari",63,55,"craft"],
  ["Odisha","Pattachitra",71,49,"art"],
  ["Kerala","Theyyam",72,69,"performance"],
  ["Tamil Nadu","Temple arts",55,72,"performance"]
];
        ...
        {page==="map"&&(
          <div className="page-wrap map-page">
            ...
            <div className="page-title">
              ...
              <p>
                Follow the cultural trails and select a state to discover its living traditions.
              </p>
...
function CulturalMap({items,onOpen,full}){
  ...
  return (
    ...
    >
      ...
      <div className="map-paper">
        ...
        <img
          src="https://commons.wikimedia.org/wiki/Special:Redirect/file/India_outline.svg"
          alt="India outline"
        />

        <div className="map-star star1">
          ✦
        </div>

        <div className="map-star star2">
          ✦
        </div>

        <div className="map-star star3">
          ✦
        </div>
      ...
      <div className="map-legend">
        ...
        <span>
          <i className="legend-dot art"></i>
          Art
        </span>

        <span>
          <i className="legend-dot music"></i>
          Music
        </span>

        <span>
          <i className="legend-dot craft"></i>
          Craft
        </span>

        <span>
          <i className="legend-dot performance"></i>
          Performance
        </span>

        <span>
          <i className="legend-dot history"></i>
          History
        </span>
